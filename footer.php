    ...
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5">
                <br><br><br>
                <!-- <img style="display:none;" src="images/white_logo.png" alt="img" class="footer_logo"/> -->
            </div>
            <div class="clearfix"></div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="footer_main_title py-3"> Sobre Nós</div>
                <div class="footer_sub_about pb-3"> Somos uma empresa interessa em divulgar notícias.
                </div>
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                <div class="footer_main_title py-3">Últimos Comentários</div>
            ...
            <div class="col-12 col-md-12 col-lg-4 ">
                <div class="footer_main_title py-3"> Últimas Notícias</div>
                <?php foreach($noticias as $item){ ?>
                    <a href="#" class="footer_img_post_6"><img src="data:image/jpeg;base64,<?= base64_encode($item['foto']) ?>" alt="img"/></a>
                <?php } ?>
...
<div class="container-fluid fh5co_footer_right_reserved">
    <div class="container">
        <div class="row  ">
            <div class="col-12 col-md-8 py-4 Reserved"> © Copyright 2022, Todos os direitos reservados. Desenhado por <a style="color:yellow" title="Mateus Tormes">Mateus Tormes</a>. </div>
            <div class="col-12 col-md-4 spdp_right py-4">
                <a href="#" class="footer_last_part_menu">Home</a>
                <a href="contact.php" class="footer_last_part_menu">About</a>
                <a href="contact.php" class="footer_last_part_menu">Contato</a>
                <a href="blog.php" class="footer_last_part_menu">Últimas Notícias</a></div>
        </div>
    </div>
</div>
